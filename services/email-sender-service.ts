...
export const emailSender = async (
  ...
  const subject = 'Your CHIRANTAN Participation Certificate';
  const pdfBytes = await pdfGenerator(name, collegeName);

	const fileName = `${name.replace(/\s+/g, '_')}_CHIRANTAN_Certificate.pdf`
												...
												<td class="column column-1" width="33.333333333333336%" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; font-weight: 400; text-align: left; padding-bottom: 5px; padding-top: 5px; vertical-align: top;">
													<table class="image_block block-1" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;">
														<tr>
															<td class="pad" style="width:100%;">
																<div class="alignment" align="center">
																	<div style="max-width: 200px;"><img src="https://i.ibb.co/prsSBCrw/Amazon-DSP-Standard-Display-Starter-Set-Version-B-White-300x600-1x-Large-Rectangle.png" style="display: block; height: auto; border: 0; width: 100%;" width="200" alt title height="auto"></div>
																</div>
															</td>
														</tr>
													</table>
														...
														<tr>
															<td class="pad">
																<div style="color:#313131;direction:ltr;font-family:'Trebuchet MS', 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', Tahoma, sans-serif;font-size:16px;font-weight:400;letter-spacing:0px;line-height:1.2;text-align:justify;mso-line-height-alt:19px;">
																	...
																	<p style="margin: 0; margin-bottom: 16px;">Thank you for your participation in CHIRANTAN 2025.</p>
																	<p style="margin: 0; margin-bottom: 16px;">&nbsp;</p>
																	...
																	<p style="margin: 0; margin-bottom: 16px;">&nbsp;</p>
																	<p style="margin: 0; margin-bottom: 16px;">Dr. Nargis Begum</p>
																	<p style="margin: 0; margin-bottom: 16px;">CHIRANTAN Coordinator</p>
																	<p style="margin: 0;">&nbsp;</p>
																</div>
															</td>
														</tr>
